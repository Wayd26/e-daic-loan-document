const en = {
  ...
  entities: {
    loan: {
      ...
      validation: {
        folderOutOfStock: 'Sorry, this folder is out of stock.',
      },
    },
    ...
    folder: {
      ...
      label: 'Folders',
      menu: 'Folders',
      exporterFileName: 'folder_export',
      list: {
        menu: 'Folders',
        title: 'Folders',
      },
      ...
      destroyAll: {
        success: 'Folder(s) deleted successfully',
      },
      edit: {
        title: 'Edit Folder',
      },
      ...
      importer: {
        ...
        fileName: 'folder_import_template',
        hint:
          'Files/Images columns must be the URLs of the files separated by space.',
      },
    },
    ...
    division: {
      ...
      create: {
        success: 'Division saved successfully',
      },
      update: {
        success: 'Division saved successfully',
      },
      ...
      destroyAll: {
        success: 'Division(s) deleted successfully',
      },
      edit: {
        title: 'Edit Division',
      },
      ...
      importer: {
        ...
        fileName: 'division_import_template',
        hint:
          'Files/Images columns must be the URLs of the files separated by space.',
      },
    },
    ...
    classement: {
      ...
      create: {
        success: 'Classement saved successfully',
      },
      update: {
        success: 'Classement saved successfully',
      },
      destroy: {
        success: 'Classement deleted successfully',
      },
      destroyAll: {
        success: 'Classement(s) deleted successfully',
      },
      edit: {
        title: 'Edit Classement',
      },
      fields: {
        id: 'Id',
        title: 'Title',
      ...
      new: {
        title: 'New Classement',
      },
      view: {
        title: 'View Classement',
      },
      importer: {
        title: 'Import Classements',
        fileName: 'classement_import_template',
        hint:
          'Files/Images columns must be the URLs of the files separated by space.',
      },
    },
    ...
    box: {
      ...
      create: {
        success: 'Box saved successfully',
      },
      update: {
        success: 'Box saved successfully',
      },
      ...
      destroyAll: {
        success: 'Box(es) deleted successfully',
      },
      edit: {
        title: 'Edit Box',
      },
