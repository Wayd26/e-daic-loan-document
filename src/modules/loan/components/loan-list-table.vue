<template>
  <div>
    ...
    >
      ...
      <el-table-column :label="fields.folder.label" :prop="fields.folder.name">
        <template slot-scope="scope">
          <app-list-item-relation-to-one
            :label="fields.folder.label"
            :permission="fields.folder.readPermission"
            :url="fields.folder.viewUrl"
            :value="presenter(scope.row, 'folder')"
          ></app-list-item-relation-to-one>
        </template>
      </el-table-column>
